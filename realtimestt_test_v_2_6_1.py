...
if __name__ == '__main__':
    ...
    console.print("[bold cyan]Ctrl+1[/bold cyan]: Mute Microphone")
    console.print("[bold cyan]Ctrl+2[/bold cyan]: Unmute Microphone")
    console.print("[bold cyan]Ctrl+3[/bold cyan]: Start Static Recording")
    console.print("[bold cyan]Ctrl+4[/bold cyan]: Stop Static Recording")
    ...
    def start_static_recording():
        ...
        console.print("[bold green]Starting static recording... Press Ctrl+F to stop.[/bold green]")
        static_audio_frames = []
