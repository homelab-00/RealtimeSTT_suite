...
if __name__ == '__main__':
    ...
    def exit_gracefully():
        """
        Handles graceful exit of the script.
        """
        ...
        # Unhook all hotkeys to stop keyboard listeners
        keyboard.unhook_all_hotkeys()
        # Alternatively, to remove all hooks (use with caution):
        # keyboard.unhook_all()
    ...
    def exit_script():
        console.print("[bold red]Exit hotkey pressed. Exiting...[/bold red]")
        exit_gracefully()
    ...
    keyboard.add_hotkey('F6', exit_script, suppress=True)
    ...
    try:
        ...
        pass  # All cleanup is handled in exit_gracefully()
