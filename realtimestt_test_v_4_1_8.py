...
if __name__ == '__main__':
    ...
    try:
        ...
        try:
            ...
            if lt_version < "2.8.0":
                ...
                import language_tool_python
                console.print("[bold green]'language-tool-python' successfully updated.[/bold green]")
        except importlib.metadata.PackageNotFoundError:
            console.print("[bold red]'language_tool_python' package not found during version check.[/bold red]")
    except Exception as e:
        console.print(f"[bold red]Failed to update 'language-tool-python': {e}[/bold red]")
    """
    ...
    try:
        # Correct Initialization: Use 'config' with 'remote_server_uri'
        tool = language_tool_python.LanguageTool('en-US', config={'remote_server_uri': 'http://localhost:8081'})
    except Exception as e:
