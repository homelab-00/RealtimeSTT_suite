...
command_words = ["luna", "luna", "luna", "lina", "lyna"]  # Add more variations as needed
...
def text_detected(text, recorder):
    ...
    if new_text != displayed_text:
        ...
        # Type the new text into the active window
        pyautogui.typewrite(text + " ")
        time.sleep(0.1)  # Small delay to ensure smooth typing
