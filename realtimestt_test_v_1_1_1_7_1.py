...
if __name__ == '__main__':
    ...
    def hotkey_listener():
        ...
        keyboard.add_hotkey('ctrl+2', unmute_microphone)
        # Assign hotkeys for static recording
        ...
        # For example:
        # keyboard.add_hotkey('ctrl+5', enable_typing)
        # keyboard.add_hotkey('ctrl+6', disable_typing)
