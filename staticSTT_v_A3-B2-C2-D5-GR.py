...
# Determine the length of decoder_input_ids, accounting for the additional start token
decoder_input_length = len(forced_decoder_ids) + 1  # Add 1 for the start token added by the model
...
generated_tokens = model.generate(
    input_features=input_features,  # Use 'input_features' as per the latest API
