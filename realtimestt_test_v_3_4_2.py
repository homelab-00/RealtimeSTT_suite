# Save this code in a file named 'realtimestt_test_v_1_0.py'
...
import pyperclip
import numpy as np
from RealtimeSTT.audio_recorder import AudioToTextRecorder  # Ensure this is the correct import path
...
if __name__ == '__main__':
    # On Windows, set the multiprocessing start method to 'spawn'
