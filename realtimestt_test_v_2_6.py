...
if __name__ == '__main__':
    ...
    console.print("[bold cyan]Ctrl+A[/bold cyan]: Mute Microphone")
    console.print("[bold cyan]Ctrl+S[/bold cyan]: Unmute Microphone")
    console.print("[bold cyan]Ctrl+D[/bold cyan]: Start Static Recording")
    console.print("[bold cyan]Ctrl+F[/bold cyan]: Stop Static Recording")
    ...
    def hotkey_listener():
        ...
        hotkeys = {
            '<ctrl>+a': mute_microphone,
            '<ctrl>+s': unmute_microphone,
            '<ctrl>+d': start_static_recording,
            '<ctrl>+f': stop_static_recording
        }
