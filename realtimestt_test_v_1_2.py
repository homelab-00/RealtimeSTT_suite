...
if __name__ == '__main__':
    ...
    def mute_mic():
        ...
        if not muted:
            try:
                ...
                console.print("[bold red]Mute functionality not available in recorder.[/bold red]")
    ...
    def unmute_mic():
        ...
        if muted:
            try:
                ...
                console.print("[bold green]Unmute functionality not available in recorder.[/bold green]")
    ...
    def hotkey_listener():
        keyboard.add_hotkey('ctrl+1', mute_mic)
        keyboard.add_hotkey('ctrl+2', unmute_mic)
