...
if __name__ == '__main__':
    ...
    def send_ctrl_c():
        """
        Sends a 'Ctrl + C' command to the script to trigger KeyboardInterrupt.
        """
        try:
            keyboard.send('ctrl+c')
            console.print("[bold red]Ctrl + C sent. Attempting to exit...[/bold red]")
        except Exception as e:
            console.print(f"[bold red]Failed to send Ctrl + C: {e}[/bold red]")
