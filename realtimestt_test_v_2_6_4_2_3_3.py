...
if __name__ == '__main__':
    ...
    console.print("[bold cyan]F6[/bold cyan]: Exit Script")  # Added F6 hotkey
    ...
    def exit_script():
        console.print("[bold yellow]Exiting via hotkey F6...[/bold yellow]")
        sys.exit(0)
    ...
    keyboard.add_hotkey('F6', exit_script, suppress=True)  # Added F6 hotkey
