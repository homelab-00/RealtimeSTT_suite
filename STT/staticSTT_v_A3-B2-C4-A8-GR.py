...
# Include an initial prompt for the model
initial_prompt = (
   "Στο τέλος μη ολοκληρωμένων προτάσεων βάζε αποσιωπητικά.\n"
   "Παραδείγματα:\n"
   "Ολοκληρωμένη: Ο ουρανός είναι μπλε.\n"
   "Μη ολοκληρωμένη: Όταν ο ουρανός...\n"
   "Ολοκληρωμένη: Εκείνη περπάτησε προς το σπίτι της.\n"
   "Μη ολοκληρωμένη: Επειδή εκείνη ήθελε...\n"
)

# Set the beam size
beam_size = 5

# Setting to the default value of RealtimeSTT
suppress_tokens = [-1]
...
# We're calculating this because we're saving the audio to disk every second to avoid losing data.
# So we need to know how many chunks (which is the unit of recording for the script) make up one second.
