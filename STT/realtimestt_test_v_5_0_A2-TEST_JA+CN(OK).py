...
if __name__ == '__main__':
    ...
    recorder_config = {
        'spinner': False,
        'model': 'zh-plus/faster-whisper-large-v2-japanese-5k-steps',  # or distil-medium.en or large-v2 or deepdml/faster-whisper-large-v3-turbo-ct2 or Systran/faster-distil-whisper-large-v3 or ...
