...
CHANNELS = 1
RATE = 16000
CHUNK = 480  # 30 ms frames for VAD
...
def record_audio():
    ...
    try:
        while recording:
            ...
            if is_speech:
                ...
                if silence_counter > SILENCE_CHUNKS:
                    console.print("[italic bold blue]Silence detected. Stopping recording...[/italic bold blue]")
                    recording = False
                    break
        ...
        recording = False
        # Automatically start transcription if recording stopped by silence
        if not transcribing:
