...
class TranscriptionWorker:
    def __init__(self, conn, stdout_pipe, model_path, compute_type, gpu_device_index, device,
                 ready_event, shutdown_event, interrupt_stop_event, beam_size, initial_prompt, suppress_tokens, transcribe_options=None):
        self.conn = conn
        ...
        self.transcribe_options = transcribe_options or {}  # Added line
                ...
                try:
                    ...
                    try:
                        segments, info = model.transcribe(
                            ...
                            **self.transcribe_options  # Use transcribe_options which includes 'language': 'el'
                        )
...
class AudioToTextRecorder:
    ...
    def __init__(self,
                 ...
                 transcribe_options = None,  # Added parameter
                 ):
        """
        ...
        self.transcribe_options = transcribe_options or {}
        ...
        self.transcript_process = self._start_thread(
            ...
            args=(
                ...
                self.transcribe_options  # Added argument
            )
        )
                ...
                if self.is_recording:
                    ...
                    if self.use_main_model_for_realtime:
                        ...
                        segments, info = self.realtime_model_type.transcribe(
                            ...
                            initial_prompt=self.initial_prompt,
                            suppress_tokens=self.suppress_tokens,
                            **self.transcribe_options,  # Added line
                        )
