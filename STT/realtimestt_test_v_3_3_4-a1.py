...
if __name__ == '__main__':
    ...
    def text_detected(text):
        ...
        # Update Live Panel with Current Live Transcription
        if text:
            rich_text = Text(text, style="bold yellow")
        else:
            rich_text = Text("Say something...", style="cyan bold")
    ...
    def process_text(text):
        ...
        if text:
            ...
            # Print the finalized sentence to the console
    ...
    # New Global Variable for Typing Control
    # typing_enabled = True  # Initialized earlier
