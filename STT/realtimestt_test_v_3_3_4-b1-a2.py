...
if __name__ == '__main__':
    ...
    from rich.panel import Panel  # Ensure this import is present
    import colorama
    import pyautogui
    import keyboard
    import pyperclip
    ...
    console.print("[bold cyan]F6[/bold cyan]: Disable Typing")  # Added: F6 Hotkey Description
    ...
    keyboard.add_hotkey('F6', disable_typing, suppress=True)  # Hotkey for disabling typing
