...
if __name__ == '__main__':
    ...
    # Start with the live microphone muted
    ...
    console.print("[bold cyan]F1[/bold cyan]: Single tap: Mute Microphone, Double tap: Unmute Microphone")
    console.print("[bold cyan]F2[/bold cyan]: Single tap: Disable Typing, Double tap: Enable Typing")
    console.print("[bold cyan]F3[/bold cyan]: Single tap: Start Static Recording, Double tap: End Static Recording")
    ...
    def start_static_recording():
        ...
        console.print("[bold green]Starting static recording... Press F3 (double tap) or F5 to stop/reset.[/bold green]")
        static_audio_frames = []
    ...
    keyboard.add_hotkey('F1, F1', unmute_microphone, suppress=True)
    keyboard.add_hotkey('F2', disable_typing, suppress=True)
    keyboard.add_hotkey('F2, F2', enable_typing, suppress=True)
    keyboard.add_hotkey('F3', start_static_recording, suppress=True)
    keyboard.add_hotkey('F3, F3', stop_static_recording, suppress=True)
    # Removed F4 hotkey
