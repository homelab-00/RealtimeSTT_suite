...
def stop_recording_and_transcribe():
    ...
    print & paste the final text, then send F4 to reset.
    """
...
def setup_hotkeys():
    ...
    keyboard.add_hotkey('F2', toggle_paste, suppress=False)
    keyboard.add_hotkey('F3', start_recording, suppress=False)
    keyboard.add_hotkey('F4', stop_recording_and_transcribe, suppress=False)
