# Filename: transcription_refinement_pipeline_with_gptneo_updated.py
...
if __name__ == '__main__':
    ...
    def initialize_gpt_neo(model_name="EleutherAI/gpt-neo-1.3B"):
        """
        Initializes the GPT-Neo-1.3B model without 8-bit quantization.
        """
    ...
    recorder_config = {
        'spinner': False,
        'model': 'Systran/faster-distil-whisper-large-v3',  # or other compatible models
        'input_device_index': 1,
        'realtime_model_type': 'tiny.en',  # or other compatible models
        'language': 'en',
