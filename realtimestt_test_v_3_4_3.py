...
import pyautogui
import pyperclip
from RealtimeSTT import AudioToTextRecorder  # Ensure this is the correct import path
...
if __name__ == '__main__':
    # Set the multiprocessing start method (optional on Windows, but explicit here)
