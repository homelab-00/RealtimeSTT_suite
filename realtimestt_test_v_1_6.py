...
# Ensure the multiprocessing start method is set to 'spawn' for Windows compatibility
if os.name == "nt":
    mp.set_start_method("spawn", force=True)

import sys
sys.path.insert(0, './')  # This assumes audio_recorder.py is in the same directory
from audio_recorder_v_1_2 import AudioToTextRecorder
...
def main():
    ...
    recorder_config = {
        ...
        # 'on_realtime_transcription_update': text_detected,  # Deprecated in your code
    ...
    try:
        if USE_MAIN_MODEL:
            ...
            while True:
                ...
                # Optionally, you can add a small sleep to prevent high CPU usage
                time.sleep(0.1)
        else:
