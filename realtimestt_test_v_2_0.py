# Starting a new version branch by starting with `realtimestt_test_v_1_1_1_7_1_1_1.py`
...
if __name__ == '__main__':
    ...
    def stop_static_recording():
        ...
        console.print("[bold green]Loading transcription model... This may take a moment.[/bold green]")
        try:
    ...
    def hotkey_listener():
        # Suppress the hotkeys so they don't get sent to the active window
        keyboard.add_hotkey('ctrl+1', mute_microphone, suppress=True)
        keyboard.add_hotkey('ctrl+2', unmute_microphone, suppress=True)
        # Assign hotkeys for static recording with suppression
        keyboard.add_hotkey('ctrl+3', start_static_recording, suppress=True)
        keyboard.add_hotkey('ctrl+4', stop_static_recording, suppress=True)
        # You can assign new hotkeys for typing if needed
        # For example:
        # keyboard.add_hotkey('ctrl+5', enable_typing, suppress=True)
        # keyboard.add_hotkey('ctrl+6', disable_typing, suppress=True)
