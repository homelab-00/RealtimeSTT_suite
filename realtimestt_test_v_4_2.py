...
def text_detected(text):
    ...
    if new_text != displayed_text:
        ...
        language = recorder.detected_language if recorder.detected_language else "Unknown"
        realtime_language = recorder.detected_realtime_language if recorder.detected_realtime_language else "Unknown"
        print(f"\nLanguage: {language} (Realtime: {realtime_language})")
